      ...
      <div className="mb-3 flex w-full">
        ...
        <div className="flex w-full items-center justify-between rounded-e-lg bg-white px-5 py-4 dark:bg-dark-secondary">
          <h3 className="flex items-center text-lg font-semibold dark:text-white">
            {status}{" "}
            <span
              className="ml-2 inline-block rounded-full bg-gray-900 p-1 text-center text-sm leading-none text-white dark:bg-dark-tertiary"
  ...
  return (
    ...
    >
      {task.attachments && task.attachments.length > 0 && (
        <Image
          src={`https://pm-ss3-images.s3.us-east-1.amazonaws.com/${task.attachments[0].fileURL}`}
      ...
      <div className="p-4 md:p-6">
        ...
        <p className="dark: text-xs text-gray-600 dark:text-neutral-500">
          {task.description}
        </p>
          ...
          <div className="flex -space-x-6 overflow-hidden">
            {task.assignee && (
              <Image
                ...
                src={`https://pm-ss3-images.s3.us-east-1.amazonaws.com/${task.assignee.profilePictureUrl!}`}
            ...
            {task.author && (
              <Image
                ...
                src={`https://pm-ss3-images.s3.us-east-1.amazonaws.com/${task.author.profilePictureUrl!}`}
