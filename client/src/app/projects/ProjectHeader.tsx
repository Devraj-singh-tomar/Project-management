...
const ProjectHeader = ({ activeTab, setActiveTab }: Props) => {
  ...
  return (
    <div className="px-4 xl:px-6">
      ...
      <div className="lgpb:4 pb-6 pt-6 lg:pt-8">
        <Header
          name="project development"
          buttonComponent={
            <button
              className="flex items-center rounded-md bg-blue-primary px-3 py-2 font-semibold text-white hover:bg-blue-600"
      ...
      <div className="flex flex-wrap-reverse gap-2 border-y border-gray-200 pb-[8px] pt-2 dark:border-stroke-dark md:items-center">
        <div className="flex flex-1 items-center gap-2 md:gap-4">
          ...
          <TabButton
            name="Timeline"
            icon={<Clock4Icon className="h-5 w-5" />}
            setActiveTab={setActiveTab}
            activeTab={activeTab}
          />
...
const TabButton = ({ activeTab, icon, name, setActiveTab }: TabButtonProp) => {
